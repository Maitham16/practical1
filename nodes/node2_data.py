...
rf_model = joblib.load('./random_forest_model_node_2.pkl')

# Load Neural Network model
nn_model = tf.keras.models.load_model('./neural_network_model_node_2.h5')

# Load scaler object
scaler = joblib.load('./scaler_node_2.pkl')
