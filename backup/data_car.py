...
charging_stations = [50, 100,150, 200, 250, 300, 350, 400, 450, 500, 550, 560, 570, 590]  # Charging station locations
...
for i in range(int(600/distance_step)):
    ...
    if data['charging']:
        ...
        if random.random() < 0.9:  # 50% chance to stop charging each time step
            data['charging'] = False
    ...
    time.sleep(time_step * 0.1)  # convert to seconds
