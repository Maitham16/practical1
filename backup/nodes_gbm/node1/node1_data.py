...
training_batch = []
accumulated_records = []
gbm_model = joblib.load('/home/maith/Desktop/practical1/models/gbm_model_node1.pkl')

# Load scaler for feature normalization
scaler = joblib.load('/home/maith/Desktop/practical1/models/gbm_scaler_node1.pkl')
...
def load_and_preprocess_data():
    ...
    data = pd.read_csv('/home/maith/Desktop/practical1/nodes_gbm/node1/node1_data.csv')
    print(data.columns)
