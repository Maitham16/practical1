...
training_batch = []
accumulated_records = []
linear_reg_model = joblib.load('/home/maith/Desktop/practical1/models/linearReg_model_node1.pkl')

# Load scaler for feature normalization
scaler = joblib.load('/home/maith/Desktop/practical1/models/linearReg_scaler_node1.pkl')
...
def load_and_preprocess_data():
    ...
    data = pd.read_csv('/home/maith/Desktop/practical1/nodes_lr/node1/node1_data.csv')
...
def predict_and_update(data):
    ...
    try:
        write_header = not os.path.exists('node1_data.csv') 
